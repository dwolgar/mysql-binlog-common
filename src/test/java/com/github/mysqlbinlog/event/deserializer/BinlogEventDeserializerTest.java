...
public class BinlogEventDeserializerTest {
    ...
    public void init() {
        ...
        BinlogEventDeserializerFactory binlogEventUnmarshallerFactory = new SimpleBinlogEventDeserializerFactoryImpl();
        
        singleBinglogEventUnmarshaller = new SimpleSingleBinglogEventDeserializerImpl();
        ((SimpleSingleBinglogEventDeserializerImpl)(singleBinglogEventUnmarshaller)).setBinlogEventHeaderParser(binlogEventHeaderParser);
        ((SimpleSingleBinglogEventDeserializerImpl)(singleBinglogEventUnmarshaller)).setBinlogEventFactory(binlogEventFactory);
        ((SimpleSingleBinglogEventDeserializerImpl)(singleBinglogEventUnmarshaller)).setBinlogEventUnmarshallerFactory(binlogEventUnmarshallerFactory);
    }
    ...
    public void QueryEventDeserializerTest() {
        ...
        QueryEvent queryEvent = (QueryEvent) singleBinglogEventUnmarshaller.deserialize(DatatypeConverter.parseHexBinary(hexEvent), binlogParserContext);

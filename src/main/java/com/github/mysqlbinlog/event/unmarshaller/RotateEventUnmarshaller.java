...
public class RotateEventUnmarshaller implements BinlogEventUnmarshaller<RotateEvent> {

    public BinlogEvent unmarshal(RotateEvent event, MysqlBinlogByteArrayInputStream is, BinlogUnmarshallerContext context) throws IOException {

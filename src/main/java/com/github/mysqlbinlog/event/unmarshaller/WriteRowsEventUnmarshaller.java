...
public class WriteRowsEventUnmarshaller extends AbstractRowEventUnmarshaller<WriteRowsEvent> {
    private boolean version2;
    
    public WriteRowsEventUnmarshaller() {
        super();
    }
    
    public WriteRowsEventUnmarshaller(boolean version2) {
        super();
    ...
    @Override
    public BinlogEvent unmarshal(WriteRowsEvent event, MysqlBinlogByteArrayInputStream is, BinlogUnmarshallerContext context) throws IOException {
    ...
    protected List<Row> parseRows(MysqlBinlogByteArrayInputStream is, TableMapEvent tme, WriteRowsEvent event) throws IOException {

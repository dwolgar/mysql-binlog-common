...
public class RandEventUnmarshaller implements BinlogEventUnmarshaller<RandEvent> {

    public BinlogEvent unmarshal(RandEvent event, MysqlBinlogByteArrayInputStream is, BinlogUnmarshallerContext context) throws IOException {

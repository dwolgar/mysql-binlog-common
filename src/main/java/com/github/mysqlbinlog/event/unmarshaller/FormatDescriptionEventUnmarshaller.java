...
public class FormatDescriptionEventUnmarshaller implements BinlogEventUnmarshaller<FormatDescriptionEvent> {

    public BinlogEvent unmarshal(FormatDescriptionEvent event, MysqlBinlogByteArrayInputStream is, BinlogUnmarshallerContext context) throws IOException {

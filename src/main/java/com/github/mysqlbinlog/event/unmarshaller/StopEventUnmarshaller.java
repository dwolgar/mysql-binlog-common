...
public class StopEventUnmarshaller implements BinlogEventUnmarshaller<StopEvent> {

    public BinlogEvent unmarshal(StopEvent event, MysqlBinlogByteArrayInputStream is, BinlogUnmarshallerContext context) throws IOException {
        return event;
    }

...
public class TableMapEventUnmarshaller implements BinlogEventUnmarshaller<TableMapEvent> {

    public BinlogEvent unmarshal(TableMapEvent event, MysqlBinlogByteArrayInputStream is, BinlogUnmarshallerContext context) throws IOException {

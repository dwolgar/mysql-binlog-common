...
public class GtidEventUnmarshaller implements BinlogEventUnmarshaller<GtidEvent> {

    public BinlogEvent unmarshal(GtidEvent event, MysqlBinlogByteArrayInputStream is, BinlogUnmarshallerContext context) throws IOException {

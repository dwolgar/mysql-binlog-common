...
public class QueryEventUnmarshaller implements BinlogEventUnmarshaller<QueryEvent> {

    public BinlogEvent unmarshal(QueryEvent event, MysqlBinlogByteArrayInputStream is, BinlogUnmarshallerContext context) throws IOException {

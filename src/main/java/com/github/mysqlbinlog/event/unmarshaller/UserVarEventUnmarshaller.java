...
public class UserVarEventUnmarshaller implements BinlogEventUnmarshaller<UserVarEvent> {

    public BinlogEvent unmarshal(UserVarEvent event, MysqlBinlogByteArrayInputStream is, BinlogUnmarshallerContext context) throws IOException {

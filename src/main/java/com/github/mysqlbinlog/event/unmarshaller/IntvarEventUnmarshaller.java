...
public class IntvarEventUnmarshaller implements BinlogEventUnmarshaller<IntvarEvent> {

    public BinlogEvent unmarshal(IntvarEvent event, MysqlBinlogByteArrayInputStream is, BinlogUnmarshallerContext context) throws IOException {

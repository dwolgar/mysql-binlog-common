...
public class XidEventUnmarshaller implements BinlogEventUnmarshaller<XidEvent> {

    public BinlogEvent unmarshal(XidEvent event, MysqlBinlogByteArrayInputStream is, BinlogUnmarshallerContext context) throws IOException {

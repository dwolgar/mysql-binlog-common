...
public class DeleteRowsEventUnmarshaller extends AbstractRowEventUnmarshaller<DeleteRowsEvent> {
    private boolean version2;
    
    public DeleteRowsEventUnmarshaller() {
        super();
    }
    
    public DeleteRowsEventUnmarshaller(boolean version2) {
        super();
        this.version2 = version2;
    }

    @Override
    public BinlogEvent unmarshal(DeleteRowsEvent event, MysqlBinlogByteArrayInputStream is, BinlogUnmarshallerContext context) throws IOException {

...
public class WriteRowsEventDeserializer extends AbstractRowEventDeserializer<WriteRowsEvent> {
    private boolean version2;
    
    public WriteRowsEventDeserializer() {
        super();
    }
    
    public WriteRowsEventDeserializer(boolean version2) {
        super();

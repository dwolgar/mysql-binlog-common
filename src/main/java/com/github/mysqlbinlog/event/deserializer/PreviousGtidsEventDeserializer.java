...
public class PreviousGtidsEventDeserializer implements
        BinlogEventDeserializer<PreviousGtidsEvent> {

    @Override
    public BinlogEvent deserialize(PreviousGtidsEvent event,
